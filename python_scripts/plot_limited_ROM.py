...
#limited ROM
x = [1.0, 0.5, 0.4, 0.3, 0.2, 0.1, 0.05, 0.025, 0.01, 0.0]
y = [38.52, 37.44, 36.92, 35.93, 33.91, 28.45, 22.47, 18.09, 14.47, 8.38] # max mouth opening distances at 100% muscle activation
x2 = [1, 0.5, 0.4, 0.2, 0.15, 0.1, 0.05, 0.01, 0.005, 0.0]
y2 = [38.82, 37.97, 37.57, 35.71, 34.53, 32.26, 25.14, 15.45, 13.19, 8.62]
